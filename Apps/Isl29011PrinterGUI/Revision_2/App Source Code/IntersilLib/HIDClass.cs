...
namespace IntersilLib
{
    ...
    public partial class HIDClass
    {
        ...
        public static HIDStatus Connect(string divice_path)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    {
                        //Step 6
                        GetFileHandes(ref GlobalVariables.MyDeviceDetected, DeviceInfoSetptr, myDeviceInterfaceData,divice_path);
                    }
        ...
        /// </summary>
        /// <returns></returns>
        public static HIDStatus CheckHIDConnStatus(string divice_path)
        {
            try
            {
        ...
        private static void GetFileHandes(ref bool myDeviceDetected, IntPtr DeviceInfoSetptr, SP_DEVICE_INTERFACE_DATA myDeviceInterfaceData,string divice_path)
        {
            ...
            try
            {
               ...
               // devicePath = Encoding.Unicode.GetString(detailDataBuffer, 0, detailDataBuffer.Length);
                devicePath = divice_path;//devicePath.Substring(2);
        ...
        /// </summary>
        /// <param name="value">value set as 0</param>
        /// <param name="numDatabytes">no of bytes to be write</param>
        /// <param name="regNo">Reg no. from where we want to read</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="value">value to b write in to register</param>
        /// <param name="numDatabytes">No. of bytes to be write</param>
        /// <param name="regNo">Register no. where we want to write</param>
        /// <returns></returns>
